/*
 ...
 Source Server         : 本地Ubuntu22.04
 Source Server Type    : MySQL
 Source Server Version : 50736
 Source Host           : 192.168.119.130:3306
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '奖品表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '抽奖活动表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '抽奖活动次数配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '规则表-树' ROW_FORMAT = Dynamic;
...
CREATE TABLE `rule_tree_node`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '规则表-树节点' ROW_FORMAT = Dynamic;
...
CREATE TABLE `rule_tree_node_line`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '规则表-树节点连线' ROW_FORMAT = Dynamic;
...
CREATE TABLE `strategy`  (
  ...
  `rule_models` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '规则模型，rule配置的模型同步到此表，便于使用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_strategy_id`(`strategy_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '抽奖策略' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '抽奖策略奖品概率' ROW_FORMAT = Dynamic;
...
INSERT INTO `strategy_award` VALUES (22, 100006, 101, '随机积分', NULL, 100, 64, 0.0200, 'tree_luck_award', 1, '2023-12-09 09:38:31', '2024-02-29 08:06:30');
...
INSERT INTO `strategy_award` VALUES (24, 100006, 103, '6等奖', NULL, 100, 48, 0.0300, 'tree_luck_award', 3, '2023-12-09 09:38:31', '2024-02-15 15:38:15');
INSERT INTO `strategy_award` VALUES (25, 100006, 104, '5等奖', NULL, 100, 45, 0.0300, 'tree_luck_award', 4, '2023-12-09 09:38:31', '2024-02-15 15:38:35');
INSERT INTO `strategy_award` VALUES (26, 100006, 105, '4等奖', NULL, 100, 41, 0.0300, 'tree_luck_award', 5, '2023-12-09 09:38:31', '2024-02-16 08:46:00');
...
INSERT INTO `strategy_award` VALUES (28, 100006, 107, '2等奖', '抽奖1次后解锁', 100, 29, 0.0300, 'tree_lock_1', 7, '2023-12-09 09:38:31', '2024-02-29 08:06:20');
...
CREATE TABLE `strategy_rule`  (
  ...
  `rule_value` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '抽奖规则比值',
  `rule_desc` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '抽奖规则描述',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_strategy_id_award_id`(`strategy_id`, `award_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '抽奖策略规则' ROW_FORMAT = Dynamic;
